        ...
        <div className="container mx-auto px-4">
          <ScrollReveal>
            <div className="flex justify-between items-end mb-12">
              ...
              <Button render={<Link href="/properties" />} variant="ghost" className="hidden sm:flex">
          ...
          <ScrollReveal>
            <Button render={<Link href="/properties" />} variant="outline" className="w-full mt-8 sm:hidden">
              View All Properties
            </Button>
          </ScrollReveal>
        </div>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <ScrollReveal>
            <div className="text-center mb-16 flex flex-col items-center">
              ...
              <p className="text-muted-foreground mb-4">The industry's most dedicated professionals.</p>
              <Button render={<Link href="/agents" />} variant="link" className="text-primary">
                View All Agents <ChevronRight className="w-4 h-4 ml-1" />
              </Button>
            </div>
          </ScrollReveal>
        ...
        <section className="py-24 relative overflow-hidden">
          ...
          <div className="container relative z-10 mx-auto px-4 text-center text-primary-foreground max-w-3xl">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button render={<Link href="/contact" />} size="lg" variant="secondary" className="px-8 rounded-full h-14 text-base font-semibold">
                Contact Us
              </Button>
              <Button render={<Link href="/properties" />} size="lg" variant="outline" className="px-8 rounded-full h-14 text-base font-semibold border-primary-foreground/20 text-primary-foreground hover:bg-primary-foreground/10">
                Browse Listings
              </Button>
            </div>
          </div>
